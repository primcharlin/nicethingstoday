...
export function Chip({ label, selected, onToggle }: ChipProps) {
  return (
    <button
      ...
      className={[
        "inline-flex w-[46%] min-h-[130px] items-center justify-center rounded-[32px] border-0 px-4 text-center text-[18px] sm:text-[20px] font-bold tracking-tight leading-snug transition-colors",
